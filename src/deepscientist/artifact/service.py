...
class ArtifactService:
    ...
    @staticmethod
    def _notification_block(value: object) -> str | None:
        return notification_block(value)

    @staticmethod
    def _append_notification_section(lines: list[str], label: str, value: object) -> None:
        append_notification_section(lines, label, value)

    @staticmethod
    def _append_notification_file_section(lines: list[str], entries: list[tuple[str, str | None]]) -> None:
        append_notification_file_section(lines, entries)
    ...
    def _format_route_label(value: object) -> str | None:
        return format_route_label(value)
    ...
    def _path_is_within(path: Path, root: Path | None) -> bool:
        return paper_live_paths.path_is_within(path, root)

    @staticmethod
    def _rewrite_workspace_legacy_parts(path: Path) -> Path:
        return paper_live_paths.rewrite_workspace_legacy_parts(path)

    @staticmethod
    def _collapse_duplicate_paper_segments(path: Path) -> Path:
        return paper_live_paths.collapse_duplicate_paper_segments(path)
    ...
    def _paper_live_path_candidates(
        ...
        *,
        ...
        return paper_live_paths.paper_live_path_candidates(
            raw_path,
    ...
    def _normalize_paper_live_path(
        ...
        *,
        ...
        return paper_live_paths.normalize_paper_live_path(
            raw_path,
            source_root=source_root,
    ...
    def _normalize_paper_live_path_list(
        ...
        *,
        ...
        return paper_live_paths.normalize_paper_live_path_list(
            values,
            source_root=source_root,
            target_root=target_root,
            current_workspace_root=current_workspace_root,
    ...
    def _normalize_selected_outline_live_payload(
        ...
        *,
        ...
        return paper_live_paths.normalize_selected_outline_live_payload(
            payload,
            source_root=source_root,
            target_root=target_root,
            current_workspace_root=current_workspace_root,
    ...
    def _normalize_paper_evidence_ledger_payload(
        ...
        *,
        ...
        return paper_live_paths.normalize_paper_evidence_ledger_payload(
            payload,
            source_root=source_root,
            target_root=target_root,
            current_workspace_root=current_workspace_root,
    ...
    def _normalize_claim_evidence_map_payload(
        ...
        *,
        ...
        return paper_live_paths.normalize_claim_evidence_map_payload(
            payload,
            source_root=source_root,
            target_root=target_root,
            current_workspace_root=current_workspace_root,
    ...
    def _normalize_display_catalog_payload(
        ...
        *,
        ...
        return paper_live_paths.normalize_display_catalog_payload(
            payload,
    ...
    def _normalize_paper_baseline_inventory_payload(
        ...
        *,
        ...
        return paper_live_paths.normalize_paper_baseline_inventory_payload(
            payload,
            source_root=source_root,
            target_root=target_root,
            current_workspace_root=current_workspace_root,
    ...
    def _paper_bundle_surface_override(
        ...
        *,
        ...
        return paper_live_paths.paper_bundle_surface_override(
            raw_path,
            source_root=source_root,
            target_paper_root=target_paper_root,
            candidate_paper_roots=self._paper_sync_roots(quest_root),
            current_workspace_root=current_workspace_root,
            legacy_workspace_roots=legacy_workspace_roots,
        )
    ...
    def _normalize_paper_bundle_manifest_payload(
        ...
        *,
        ...
        return paper_live_paths.normalize_paper_bundle_manifest_payload(
            payload,
            source_root=source_root,
            target_paper_root=target_paper_root,
            candidate_paper_roots=self._paper_sync_roots(quest_root),
    ...
    def _paper_bundle_relative_path(
        ...
        *,
        ...
        return paper_live_paths.paper_bundle_relative_path(
            path,
