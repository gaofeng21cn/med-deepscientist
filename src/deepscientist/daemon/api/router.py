...
ROUTES: list[tuple[str, re.Pattern[str], str]] = [
    ...
    ("GET", re.compile(r"^/api/admin/system/overview$"), "system_overview"),
    ("GET", re.compile(r"^/api/system/quests$"), "system_quests"),
    ("GET", re.compile(r"^/api/admin/system/quests$"), "system_quests"),
    ("GET", re.compile(r"^/api/system/quests/(?P<quest_id>[^/]+)/summary$"), "system_quest_summary"),
    ("GET", re.compile(r"^/api/admin/system/quests/(?P<quest_id>[^/]+)/summary$"), "system_quest_summary"),
    ("GET", re.compile(r"^/api/system/runtime/sessions$"), "system_runtime_sessions"),
    ("GET", re.compile(r"^/api/admin/system/runtime/sessions$"), "system_runtime_sessions"),
    ("GET", re.compile(r"^/api/system/logs/sources$"), "system_log_sources"),
    ("GET", re.compile(r"^/api/admin/log-sources$"), "system_log_sources"),
    ("GET", re.compile(r"^/api/system/logs/(?P<source_id>.+)/tail$"), "system_log_tail"),
    ("GET", re.compile(r"^/api/admin/logs/(?P<source_id>.+)/tail$"), "system_log_tail"),
    ("GET", re.compile(r"^/api/admin/logs/(?P<source_id>.+)$"), "system_log_tail"),
    ("GET", re.compile(r"^/api/system/failures$"), "system_failures"),
    ("GET", re.compile(r"^/api/admin/system/failures$"), "system_failures"),
    ("GET", re.compile(r"^/api/system/runtime-tools$"), "system_runtime_tools"),
    ("GET", re.compile(r"^/api/admin/system/runtime-tools$"), "system_runtime_tools"),
    ("GET", re.compile(r"^/api/system/hardware$"), "system_hardware"),
    ("GET", re.compile(r"^/api/admin/system/hardware$"), "system_hardware"),
    ("GET", re.compile(r"^/api/system/charts$"), "system_chart_catalog"),
    ("GET", re.compile(r"^/api/admin/system/charts$"), "system_chart_catalog"),
    ("GET", re.compile(r"^/api/system/charts/(?P<chart_id>[^/]+)$"), "system_chart_query"),
    ("GET", re.compile(r"^/api/admin/system/charts/(?P<chart_id>[^/]+)$"), "system_chart_query"),
    ("GET", re.compile(r"^/api/system/stats/summary$"), "system_stats_summary"),
    ("GET", re.compile(r"^/api/admin/system/stats/summary$"), "system_stats_summary"),
    ("GET", re.compile(r"^/api/system/search$"), "system_search"),
    ("GET", re.compile(r"^/api/admin/search$"), "system_search"),
